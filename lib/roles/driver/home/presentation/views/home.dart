...
import 'package:ezyride_frontend/roles/driver/home/presentation/widgets/shift_insight_widget.dart';
          ...
          child: Container(
              ...
              child: Stack(
                children: [
                  ...
                  getShiftInsights(context),
                  Positioned(
                    bottom: getDynamicHeight(context, 40),
                    left: getDynamicWidth(context, 20),
                    right: getDynamicWidth(context, 20),
                    child: InkWell(
                      onTap: () {
                        Navigator.pushNamed(
                            context, AppRouteNames.driverRideRequestGenerated);
                      },
                      child: Container(
