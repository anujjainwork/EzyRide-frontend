...
class DriverEndRide extends StatefulWidget {
  const DriverEndRide({super.key});

  @override
  State<DriverEndRide> createState() => _DriverEndRideState();
}

class _DriverEndRideState extends State<DriverEndRide> {
  String? distanceLeft;
